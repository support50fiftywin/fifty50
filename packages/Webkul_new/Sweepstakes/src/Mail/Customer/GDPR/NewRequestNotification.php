...
namespace Webkul\Sweepstakes\Mail\Customer\GDPR;
...
class NewRequestNotification extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subjectKey = $this->gdprRequest->type === 'update'
            ? 'Sweepstakes::app.emails.customers.gdpr.new-update-request'
            : 'Sweepstakes::app.emails.customers.gdpr.new-delete-request';
