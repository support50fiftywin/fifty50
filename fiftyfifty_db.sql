...
CREATE TABLE `entries` (
  ...
  `sweepstakes_id` bigint(20) UNSIGNED NOT NULL,
  `merchant_id` bigint(20) UNSIGNED DEFAULT NULL,
  `entry_source` enum('stripe','clover','shopify','admin') NOT NULL,
...
(4, '2025_12_01_074140_create_permission_tables', 1),
(5, '2025_12_01_104838_create_sweepstakes_table', 2),
(6, '2025_12_01_104839_create_entries_table', 2),
...
(1, 'Admin', 'web', '2025-12-01 02:59:44', '2025-12-01 04:41:44'),
(2, 'Merchant', 'web', '2025-12-01 02:59:44', '2025-12-01 04:41:44'),
(3, 'User', 'web', '2025-12-01 02:59:44', '2025-12-01 04:41:44');
...
ALTER TABLE `entries`
  ...
  ADD KEY `entries_sweepstakes_id_foreign` (`sweepstakes_id`),
  ADD KEY `entries_merchant_id_foreign` (`merchant_id`);
...
ALTER TABLE `sweepstakes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sweepstakes_winner_user_id_foreign` (`winner_user_id`);
...
--
ALTER TABLE `entries`
  ADD CONSTRAINT `entries_merchant_id_foreign` FOREIGN KEY (`merchant_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `entries_sweepstakes_id_foreign` FOREIGN KEY (`sweepstakes_id`) REFERENCES `sweepstakes` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `sweepstakes`
--
ALTER TABLE `sweepstakes`
  ADD CONSTRAINT `sweepstakes_winner_user_id_foreign` FOREIGN KEY (`winner_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
COMMIT;
